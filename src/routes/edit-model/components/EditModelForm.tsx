...
export const EditModelForm = ({ model, storageProviders, teams }: EditModelFormProps) => {
    const navigate = useNavigate();

    const [editModel, { loading: createModelLoading }] = useEditModel();
    ...
    const form = useZodForm({
        ...
        defaultValues: {
            ...
            storageProviderId: model.storageProvider.providerId,
        },
    });
                ...
                <div className='grid grid-cols-1 gap-x-4 gap-y-6 sm:grid-cols-6'>
                    ...
                    <div className='col-span-full sm:col-span-3'>
                        <FieldWrapper label='Model Name'>
                            <TextInput
                                defaultValue={form.formState.defaultValues?.modelName}
                        ...
                        <FieldWrapper label='Storage Provider'>
                            <Controller
                                ...
                                render={({ field: { onChange, value, ref } }) => (
                                    <Select
                                        defaultValue={
                                            form.formState.defaultValues?.storageProviderId
                                        }
                                        onValueChange={onChange}
                                        ref={ref}
                                        value={value}
